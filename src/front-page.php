...
<head>
	...
	<!-- OGP -->
	<meta property="og:image" content="<?php echo get_template_directory_uri(); ?>/images/ogp.png"><!--※データ渡し時は公開ドメインに修正-->
	...
	<link rel="icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/images/android-touch-icon.png" sizes="192x192">
...
<body id="index">
	...
	<header class="l-header">
		<h1 class="l-header__logo">
			<a href="/" class="l-header__logo-link" aria-label="トップページへ戻る"><img class="l-header__logo-img" src="<?php echo get_template_directory_uri(); ?>/images/header-logo.png" alt="学校法人 富田学園 岐阜東高等学校" width="" height=""></a>
		</h1>
		...
		<article>
			...
			<section class="p-index-fv">
				<div class="p-index-fv__inner">
					<picture>
						<source srcset="<?php echo get_template_directory_uri(); ?>/images/index_fv_fv_sp.jpg" media="(max-width: 500px)">
						<img class="p-index-fv__movie" src="<?php echo get_template_directory_uri(); ?>/images/index_fv_fv.jpg" alt="ムービーが入ります">
					</picture>
					<div class="p-index-fv__title-wrapper js-fv-title">
						<!-- <picture>
							<source srcset="<?php echo get_template_directory_uri(); ?>/images/index_fv_title_sp.png" media="(max-width: 500px)">
							<img class="p-index-fv__title" src="<?php echo get_template_directory_uri(); ?>/images/index_fv_title.png" alt="やりぬく精神で未来へ羽ばたけ">
						</picture> -->
						<span class="p-index-fv__mask mask01">
							<img class="p-index-fv__title-img01" src=" <?php echo get_template_directory_uri(); ?>/images/index_fv_title01.png" alt="">
						</span>
						<span class="p-index-fv__mask mask02">
							<img class="p-index-fv__title-img02" src="<?php echo get_template_directory_uri(); ?>/images/index_fv_title02.png" alt="">
						</span>
						<span class="p-index-fv__mask mask03">
							<img class="p-index-fv__title-img03" src="<?php echo get_template_directory_uri(); ?>/images/index_fv_title03.png" alt="">
						</span>
					...
					<ul class="p-index-post__post-list">
						<li class="p-index-post__post-item">
							<a class="p-index-post__post-link" href="">
								...
								<div class="p-index-post__img-wrapper">
									<img class="p-index-post__post-img" src="<?php echo get_template_directory_uri(); ?>/images/index_news_post01.jpg" alt="">
								</div>
						...
						<li class="p-index-post__post-item">
							<a class="p-index-post__post-link" href="">
								...
								<div class="p-index-post__img-wrapper">
									<img class="p-index-post__post-img" src="<?php echo get_template_directory_uri(); ?>/images/index_news_post02.jpg" alt="">
								</div>
						...
						<li class="p-index-post__post-item">
							<a class="p-index-post__post-link" href="">
								...
								<div class="p-index-post__img-wrapper">
									<img class="p-index-post__post-img" src="<?php echo get_template_directory_uri(); ?>/images/index_news_post00.jpg" alt="">
								</div>
					...
					<ul class="p-index-post__post-list">
						<li class="p-index-post__post-item">
							<a class="p-index-post__post-link" href="">
								...
								<div class="p-index-post__img-wrapper">
									<img class="p-index-post__post-img" src="<?php echo get_template_directory_uri(); ?>/images/index_news_post03.jpg" alt="">
								</div>
						...
						<li class="p-index-post__post-item">
							<a class="p-index-post__post-link" href="">
								...
								<div class="p-index-post__img-wrapper">
									<img class="p-index-post__post-img" src="<?php echo get_template_directory_uri(); ?>/images/index_news_post04.jpg" alt="">
								</div>
			...
			<section class="p-index-movie">
				...
				<a class="p-index-movie__link moveItem2" href="">
					<img class="p-index-movie__movie" src="<?php echo get_template_directory_uri(); ?>/images/index_movie_img.jpg" alt="">
				</a>
			...
			<section class="p-index-policy">
				...
				<div class="p-index-policy__en-wrapper">
					<img class="p-index-policy__en-heading" src="<?php echo get_template_directory_uri(); ?>/images/index_policy_en-title.png" alt="school policy">
				</div>

				<div class="p-index-policy__2col-box">
					<div class="p-index-policy__message">
						<h2 class="p-index-policy__heading">
							<img class="p-index-policy__ja-heading" src="<?php echo get_template_directory_uri(); ?>/images/index_policy_ja-title.png" alt="心身ともに剛健な人材の育成">
						</h2>
						...
						<a class="p-index-policy__message-link c-right-white" href="">
							<picture>
								<source srcset="<?php echo get_template_directory_uri(); ?>/images/index_policy_grand-design_sp.png" media="(max-width: 500px)">
								<img class="p-index-policy__message-img" src="<?php echo get_template_directory_uri(); ?>/images/index_policy_grand-design.png" alt="岐阜東高等学校が目指す教育 grand design">
							</picture>
					...
					<div class="p-index-policy__overflow js-fade-stagger">
						<div class="p-index-policy__grid-images">
							<img class="p-index-policy__grid-img grid01" src="<?php echo get_template_directory_uri(); ?>/images/index_policy_student01.png" alt="">

							<img class="p-index-policy__grid-img grid02" src="<?php echo get_template_directory_uri(); ?>/images/index_policy_student02.png" alt="">

							<div class="p-index-policy__img-wrapper">
								<img class="p-index-policy__grid-img grid03" src="<?php echo get_template_directory_uri(); ?>/images/index_policy_student03.png" alt="">

								<img class="p-index-policy__grid-img grid04" src="<?php echo get_template_directory_uri(); ?>/images/index_policy_student04.png" alt="">
							</div>
						</div>
					</div>
				</div>
			...
			<section class="p-index-intro">
				<div class="p-index-intro__img-wrapper">
					<picture>
						<!-- <source srcset="<?php echo get_template_directory_uri(); ?>/images/index_intro_main01_sp.jpg" media="(max-width: 500px)"> -->
						<img class="p-index-intro__main-img main01 js-parallax" src="<?php echo get_template_directory_uri(); ?>/images/index_intro_main01.jpg" alt="" data-y="-20vw">
					</picture>
				...
				<div class="p-index-intro__img-wrapper">
					<img class="p-index-intro__main-img main02 js-parallax" src="<?php echo get_template_directory_uri(); ?>/images/index_intro_main02.jpg" alt="" data-y="-20vw">
					</picture>
				</div>
				<div class="p-index-intro__text-bg">
					<a class="p-index-intro__link" href="">
			...
			<div class="splide js-splide p-index-others__splide" role="group" aria-label="学校生活の様子">
				<div class="splide__track">
					<ul class="splide__list">
						<li class="splide__slide"><img src="<?php echo get_template_directory_uri(); ?>/images/index_entrance_slider01.jpg" alt=""></li>
						<li class="splide__slide"><img src="<?php echo get_template_directory_uri(); ?>/images/index_entrance_slider02.jpg" alt=""></li>
						<li class="splide__slide"><img src="<?php echo get_template_directory_uri(); ?>/images/index_entrance_slider03.jpg" alt=""></li>
						<li class="splide__slide"><img src="<?php echo get_template_directory_uri(); ?>/images/index_entrance_slider04.jpg" alt=""></li>
						<li class="splide__slide"><img src="<?php echo get_template_directory_uri(); ?>/images/index_entrance_slider05.jpg" alt=""></li>
						<li class="splide__slide"><img src="<?php echo get_template_directory_uri(); ?>/images/index_entrance_slider06.jpg" alt=""></li>
						<li class="splide__slide"><img src="<?php echo get_template_directory_uri(); ?>/images/index_entrance_slider07.jpg" alt=""></li>
			...
			<div class="l-footer__top">
				<div class="l-footer__school-info">
					...
					<a class="l-footer__insta-link" href="" aria-label="インスタグラムのページへ行く" target="_blank" rel="noopener noreferrer">
						<img class="l-footer__insta-img" src="<?php echo get_template_directory_uri(); ?>/images/footer_instagram.png" alt="instagram follow us" width="315" height="35">
					</a>
				</div>
